...
\begin{frame}{Critério de Nyquist e Aliasing}
        ...
        \begin{columns}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=1.1\linewidth]{images/2.png}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=1.1\linewidth]{images/3.png}
...
\begin{frame}{Amostragem Flat-Top}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.75\linewidth]{images/5.png}
...
\begin{frame}{Reconstrução do Sinal por Amostragem Topo-Plano}
    \begin{itemize}
        \item Por fim, seja $X_{FT}(f) = {{\tau}\over {T_s}} \cdot sinc(f\tau) \sum_{k=-\infty}^{\infty} X(f-kfs) \cdot e^{-j\pi ft}$, a reconstrução a partir da amostragem topo-plano difere das demais, tendo a sua reconstrução feita da seguinte forma:
            \begin{itemize}
