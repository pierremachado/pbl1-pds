function fig = plotOriginalAndReconstructedFigure( ...
    ...
    subplot(3, 2, 1);
    plot(time, x_orig, 'r-', 'LineWidth', 1.5);
    ...
    subplot(3, 2, 2);
    plot(time, x_recon, 'b-', 'LineWidth', 1.5);
    ...
    subplot(3, 2, 3);
    stem(freqs, abs(amps_orig), 'r', 'Filled', 'LineWidth', 1.5, 'MarkerFaceColor', 'r');
    ...
    subplot(3, 2, 4);
    stem(freqs, abs(amps_recon), 'b', 'Filled', 'LineWidth', 1.5, 'MarkerFaceColor', 'b');
    ...
    subplot(3, 2, 5);
    stem(freqs, angle(amps_orig), 'r', 'Filled', 'LineWidth', 1.5, 'MarkerFaceColor', 'r');
    ...
    amps_recon_clean = amps_recon;
    amps_recon_clean(abs(amps_recon) < 1e-10) = 0; 
